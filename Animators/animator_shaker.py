...
from Logic.animation_logic import shaker_animation_logic
from Logic.hit_logic import shaker_hit_logic


class ShakerAnimator:
    """Converts shaker audio data into frame-based animation layers."""
    ...
    def get_hit_data(self):
        ...
        return shaker_hit_logic(hit_data)
