...
from Animators.animator_pad import PadAnimator
...
PAD_AUDIO_PATH = "./Audio_files/stems/The_Lost_Chord.wav"
...
def main():
    ...
    pad_audio_data = pad_analyzer.get_audio_data()
    ...
    #pad_animator.print_json("PAD_hit_data.json")
